...
export const en: Dict = {
  ...
  'chat.amrCard.switchBody': 'Switch to xDesign Cloud — no API key setup needed. After you sign in, authorize, and top up, this run retries automatically.',
  ...
  'chat.amrCard.switchCta': 'Switch to xDesign Cloud & retry',
  'chat.amrError.authMessage': 'Your xDesign Cloud account isn\'t authorized yet. Authorize it and this run retries automatically.',
  'chat.amrError.balanceMessage': 'Your xDesign Cloud allowance has run out. Top up to keep this run going.',
  ...
  'chat.amrBalanceGate.benefitsTitle': 'What you get with xDesign Cloud',
  ...
  'chat.amrBalanceGate.signedOutMessage': 'You\'re using the xDesign Cloud agent — sign in and this task can start right away.',
  ...
  'chat.runError.signInMessage.amr': 'The xDesign Cloud agent isn\'t signed in yet — sign in to start using it.',
  'chat.runError.signInMessage.other': '{agent} isn\'t signed in. Check its sign-in status locally. We recommend the xDesign Cloud agent — steadier and better value.',
  ...
  'chat.runError.cpuUnsupportedMessage': "This agent's runtime needs a CPU instruction set (AVX2) that this device doesn't have, so it can't start. Update xDesign to the latest version, which ships a compatible runtime.",
  ...
  'settings.welcomeTitle': 'Welcome to xDesign',
  'settings.welcomeSubtitle': '',
  'settings.onboardingCreateTitle': 'Start from a brief',
  'settings.onboardingCreateBody': 'Describe the site, app, deck, image, or video you want. xDesign will create a project and keep the work editable.',
  ...
  'settings.onboardingMemoryCalloutBody': 'These answers seed your Memory profile. xDesign reuses it on every task — and keeps learning as you work.',
  ...
  'settings.onboardingExecutionBody': 'Use the xDesign hosted service, connect a local coding agent, or bring your own model key.',
  ...
  'settings.onboardingGateTooltipAmr': 'The next steps run on AI — sign in to xDesign Cloud to continue.',
  ...
  'settings.agentInstall.pathHint': 'If you installed a CLI with npm or Homebrew and it still shows as not installed, ensure the tool\'s bin directory is on the PATH the xDesign daemon inherits (Terminal vs GUI apps can differ on macOS). See QUICKSTART.md (section "Local agent CLI and PATH").',
  'settings.agentInstall.stepOpenLinks': 'Open Install or Docs for your preferred agent.',
  'settings.agentInstall.stepAuth': 'Authenticate with the vendor CLI (sign in or add API credentials) before returning to xDesign.',
  ...
  'settings.amrAccountStatus': 'xDesign Cloud account status',
  ...
  'settings.mcpServerHint': 'Expose xDesign as an MCP server for your coding agent.',
  ...
  'settings.privacyHint': 'What data is shared with the xDesign team',
  'settings.privacyConsentKicker': 'Help us improve xDesign',
  'settings.privacyConsentLead': 'Sharing usage data helps us understand how xDesign performs in real workflows, so we can improve the parts that matter most to your experience.',
  ...
  "settings.allowSilentUpdatesDesc": "When an in-app update is ready, install it automatically the next time xDesign starts. Does not upgrade the current session. Installer updates still ask first.",
  ...
  'settings.updateQuitFailed': 'The installer opened, but xDesign could not quit automatically.',
  ...
  'settings.mcpTitle': 'Connect xDesign to your coding agent',
  'settings.mcpHint': 'Use MCP to give supported agents access to your projects and design context.',
  'settings.mcpDaemonError': 'Couldn\'t reach the local daemon to resolve install paths ({error}). Make sure xDesign is running, then reopen this panel.',
  ...
  'settings.mcpCapabilityDefault': 'Use the project and file currently open in xDesign as context.',
  'settings.mcpRunningNote': 'Keep xDesign running. Restart your coding agent after setup.',
  ...
  'entry.discordAria': 'Join the xDesign Discord',
  'entry.discordAriaWithOnline': 'Join the xDesign Discord - {online}',
  'entry.discordOnlineLabel': '{count} online',
  'entry.mailAria': 'Email xDesign',
  ...
  'entry.followLinkedinLabel': 'Follow xDesign on LinkedIn',
  'entry.followXiaohongshuLabel': 'Follow xDesign on Xiaohongshu',
  ...
  "entry.cloudCalloutBody": "Sign in to use xDesign Cloud and collaborate in the cloud",
  "entry.cloudCalloutDismissAria": "Dismiss xDesign Cloud note",
  ...
  'homeHero.chip.createPluginHint': 'Author a reusable xDesign plugin and add it to My plugins.',
  ...
  'handoff.amrWebsite': 'Visit xDesign Cloud',
  ...
  'handoff.promptIntro': 'Continue from this local xDesign project folder:',
  ...
  'designSystemPicker.noPreview': 'No preview page. xDesign Systems to view the full preview.',
  ...
  'pluginsHome.subtitle': 'Ready-to-use xDesign workflows bundled with this runtime. Pick one to load a starter prompt, or browse the registry for more.',
  'pluginsHome.browseRegistry': 'Browse registry',
  'pluginsHome.count': '{filtered} of {total}',
  'pluginsHome.loadingCatalog': 'Loading catalog…',
  'pluginsHome.emptyCatalog': 'Catalog is empty. Bundled plugins ship with xDesign and should appear here automatically — try restarting the daemon if this persists.',
  ...
  'pluginCard.contributeAria': 'Contribute {title} to xDesign',
  'pluginCard.contributeTitle': 'Contribute plugin to xDesign with a pull request',
  ...
  'integrations.lede': 'Connect external systems, bring MCP tools into your agent loop, and use xDesign from other IDEs, scripts, and automations.',
  ...
  'mcpClient.daemonError': 'Could not reach the local daemon. Make sure xDesign is running, then reopen this panel.',
  'mcpClient.saveFailed': 'Save failed. Check that the daemon is running and try again.',
  'useEverywhere.modalAria': 'Use xDesign everywhere',
  'useEverywhere.modalTitle': 'Use xDesign everywhere',
  'useEverywhere.modalSubtitle': 'Drop xDesign into any IDE, agent, or script — CLI, HTTP, MCP, and Skills. Use “Copy guide for an agent” and paste into Claude Code, Codex, Cursor, openclaw, or hermes to set up everything.',
  ...
  'useEverywhere.section.overview.heading': 'xDesign works wherever your agent works',
  'useEverywhere.section.overview.intro': 'xDesign is more than a window — it is a local privileged daemon (`od`) plus a Skills + Design-Systems + Atoms registry. Once it is running on your machine, any code agent (Claude Code, Codex, Cursor, OpenCode/openclaw, Hermes, your own script) can drive generations, inspect projects, and produce design artifacts through four interchangeable surfaces.',
  'useEverywhere.section.overview.bullet1': 'CLI — `od <command>` for headless scripts, CI, and shell automation.',
  'useEverywhere.section.overview.bullet2': 'MCP server — wires xDesign as a Model Context Protocol server so any MCP-capable agent can list skills, run scenarios, and read artifacts.',
  ...
  'useEverywhere.section.overview.bullet4': 'Skills — drop-in `SKILL.md` packs (Claude-compatible) that any agent already on your PATH can invoke without xDesign at all.',
  ...
  'useEverywhere.section.cli.heading': 'Drive xDesign from any shell',
  ...
  'useEverywhere.section.mcp.heading': 'Expose xDesign as an MCP server to any coding agent',
  'useEverywhere.section.mcp.intro': 'xDesign ships with a Model Context Protocol server (`od mcp`) that lets any MCP-capable client — Cursor, Claude Code, Antigravity, VS Code Copilot Chat, openclaw, hermes — discover xDesign tools (list skills, render previews, generate media, run plugins) without shelling out manually. The daemon publishes a ready-to-paste install snippet via `GET /api/mcp/install-info` for each major client.',
  ...
  'useEverywhere.section.mcp.footer': 'In the xDesign app, open Settings → Integrations to copy a client-specific install command (Cursor, Claude Code, Antigravity, VS Code) instead of editing JSON by hand.',
  ...
  'useEverywhere.section.skills.heading': 'Drop-in Skills for any agent — even without xDesign running',
  'useEverywhere.section.skills.intro': 'A Skill is a directory with a Claude-compatible `SKILL.md` (YAML front-matter + body). xDesign extends the format with the `od:` namespace (`mode`, `preview`, `design_system`, `inputs`, …) so the same artifact can be used both inside xDesign and by a vanilla agent like Claude Code, Codex, openclaw, or hermes. Discovery follows a precedence chain so projects can override their own skills.',
  ...
  'useEverywhere.section.skills.snippet1': 'Minimal SKILL.md (Claude-compatible front matter + xDesign extras)',
  ...
  'entry.githubStarAria': 'Star xDesign on GitHub',
  ...
  'newproj.locationDefault': 'xDesign projects',
  ...
  'avatar.amrConsole': 'xDesign Cloud',
  ...
  'socialShare.openDesignSection': 'Share xDesign',
  'socialShare.openDesignTitle': 'xDesign on GitHub',
  'socialShare.openDesignText': 'xDesign is a source-available workspace for creating, editing, deploying, and handing off design artifacts.',
  ...
  'socialShare.projectText': 'Built with xDesign: {title}. View the deployed artifact and star the repo: {repo}',
  'socialShare.projectCopyText': 'Built with xDesign: {title}\n{url}\nxDesign repo: {repo}',
  ...
  'brandEnrichment.body': "xDesign will run a deeper extraction in the background, apply the right design-system skills automatically, and update this system in place. This can take 10-20 minutes; you can keep working.",
  ...
  'chat.activeFilePlaceholder': 'Ask xDesign to change {file}...',
  ...
  'chat.mode.design.solves': 'Use it when you want xDesign to generate files, update the workspace, or turn a brief into multimodal deliverables.',
  ...
  'preview.errorBody': 'The example HTML failed to fetch. Make sure xDesign is running and try again.',
  'preview.retry': 'Retry',
  ...
  'designFiles.usefulInfoTip7': 'Enjoying xDesign? Star us on GitHub.',
  ...
  'designFiles.usefulInfoTip18': 'Subscribe to xDesign on YouTube for tutorials and demos.',
  'designFiles.usefulInfoTip19': 'Follow xDesign on LinkedIn for product news.',
  'designFiles.usefulInfoTip20': 'Follow xDesign on Xiaohongshu for tips and inspiration.',
  ...
  'fileViewer.publishFileRequiresWorkspace': 'Publishing a public link needs a signed-in workspace. Sign in to xDesign Cloud, or use Deploy to publish this file.',
  ...
  'assistant.shareToOpenDesign': 'Share to xDesign',
  ...
  'pet.tabBuiltInHint': 'Curated companions bundled with xDesign — pick one and adopt.',
  ...
  'pet.codexBundledTitle': 'Ships with xDesign — no download needed.',
  ...
  'settings.projectLocationsDescription': 'Add work bases that can contain multiple xDesign project folders. New projects are saved as one folder inside the selected base.',
  ...
  'updater.availableBody': 'xDesign {version} is available. It will download before the installer can open.',
  'updater.activeRunsTitle': 'xDesign is still working',
  'updater.activeRunsBody': '{count} active tasks are still running. Restarting now will interrupt them.',
  'updater.activeRunsUnknownBody': 'xDesign could not confirm whether tasks are still running. Restarting now may interrupt active work.',
  ...
  'updater.installerOpenBody': 'The installer is open. xDesign is quitting so you can finish the update.',
  ...
  'updater.quitButton': 'Quit xDesign',
  'updater.quitFailedBody': 'The installer is open, but xDesign could not quit. Quit xDesign before replacing the app.',
  'updater.quitFailedTitle': 'Could not quit',
  'updater.quitting': 'Quitting...',
  'updater.ready': 'Update ready',
  'updater.readyGeneric': 'A new version is ready. xDesign will close and open the installer.',
  'updater.readyVersion': 'xDesign {version} is ready. xDesign will close and open the installer.',
  'updater.reinstallLearnMore': 'Learn more',
  'updater.reinstallReadyGeneric': 'This update requires a full reinstall. xDesign will close and open the installer.',
  'updater.reinstallReadyVersion': 'xDesign {version} requires a full reinstall. xDesign will close and open the installer.',
  ...
  'whatsNew.updatedTitle': 'xDesign {version} is here',
  ...
  'dsManager.createBody': 'Teach xDesign your brand, product, code, assets, and design references.',
  ...
  'settings.customInstructionsDesc': 'Fixed instructions xDesign follows in every chat. These are not saved memories; use Memory for facts, preferences, and project context.',
  ...
  'brand.librarySubtitle': 'Teach xDesign your design systems — extract one from a website, then apply it in any chat.',
  ...
  'onboarding.buildBody': 'xDesign turns your brand into a reusable design system — then keeps everything you build on-brand and consistent.',
  ...
  'campaign.deepseekV4Flash.ruleSummary': 'From Aug 6–13, paid users can use DeepSeek V4 Flash for free in xDesign. Large-scale abuse may pause campaign access.',
  'campaign.deepseekV4Flash.windowLabel': 'Aug 6–13',
  'campaign.deepseekV4Flash.weekFreeSuffix': 'one week free',
  'campaign.deepseekV4Flash.boundary': 'Unlimited model quota and free generation counts in your plan apply only inside xDesign — not via MCP, CLI, API, or other surfaces. Final interpretation rests with xDesign.',
