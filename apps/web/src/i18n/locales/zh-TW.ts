...
export const zhTW: Dict = {
  ...
  'invite.landing.subtitle': "你受邀加入 xDesign 一起協作。",
  ...
  'invite.success.body': "正在開啟 xDesign，開始協作。",
  'invite.success.roleReceipt': "加入身分",
  'invite.success.enter': "進入工作空間",
  'invite.open.cta': "開啟 xDesign",
  'invite.open.opening': "正在開啟 xDesign…",
  'invite.open.retry': "已安裝？再次嘗試開啟",
  'invite.notInstalled.title': "沒有自動開啟？",
  'invite.notInstalled.body': "你的裝置可能尚未安裝 xDesign。安裝後重新開啟此連結即可完成加入。",
  'invite.notInstalled.download': "下載 xDesign",
  ...
  "chat.amrCard.switchBody":
    "可切換到 xDesign Cloud 官方模型服務，無需設定 API Key。完成登入、授權與儲值後，將自動重試目前任務。",
  "chat.amrCard.chipOfficial": "官方代管",
  "chat.amrCard.chipNoKey": "無需 API Key",
  "chat.amrCard.chipAutoRetry": "授權後自動重試",
  "chat.amrCard.switchCta": "切換到 xDesign Cloud 並重試",
  "chat.amrError.authMessage":
    "xDesign Cloud 帳號尚未授權。完成授權後將自動重試目前任務。",
  "chat.amrError.balanceMessage":
    "xDesign Cloud 額度不足。儲值後即可繼續執行目前任務。",
  ...
  "chat.amrBalanceGate.benefitsTitle": "xDesign Cloud 為你提供",
  ...
  "chat.amrBalanceGate.signedOutTitle": "登入 xDesign Cloud，開始創作",
  "chat.amrBalanceGate.signedOutMessage": "目前使用的是 xDesign Cloud 智能體，登入後這個任務馬上就能開始。",
  ...
  "chat.runError.signInMessage.amr":
    "xDesign Cloud 智慧體尚未登入，前往登入即可正常使用",
  "chat.runError.signInMessage.other":
    "{agent}尚未登入，請在本機檢查登入狀態。推薦使用 xDesign Cloud 智慧體，更穩定划算",
  ...
  "chat.runError.cpuUnsupportedMessage": "此智能體的執行時需要此裝置處理器不支援的指令集（AVX2），因此無法啟動。請將 xDesign 更新到最新版本，新版本附帶相容的執行時。",
  "common.cancel": "取消",
  ...
  "chat.contextPrompt.referenceProject":
    "請把 xDesign 專案「{name}」作為參考上下文。它的本機路徑是：{path}。在設計或修改前，如有幫助請先搜尋並讀取這個目錄。",
  ...
  "settings.welcomeTitle": "歡迎使用 xDesign",
  "settings.welcomeSubtitle": "",
  "settings.onboardingCreateTitle": "從一句需求開始",
  "settings.onboardingCreateBody":
    "描述你想做的網站、應用、Deck、圖片或影片，xDesign 會建立專案，並保留可繼續編輯的產出。",
  ...
  "settings.onboardingMemoryCalloutBody":
    "這些回答會構成你的記憶檔案。xDesign 會在每個任務中重複使用它，並在你工作時持續學習。",
  ...
  "settings.onboardingExecutionBody":
    "使用 xDesign 託管服務、連接本機 Agent，或使用你自己的模型 Key。",
  ...
  "settings.onboardingAmrModelSourceLabel": "xDesign 託管",
  ...
  "settings.onboardingCloudTitle": "登入 xDesign",
  "settings.onboardingCloudBody":
    "登入後可直接用雲端 AI 開始設計，無需任何複雜設定。",
  "settings.onboardingCloudSignIn": "登入 xDesign 雲端",
  ...
  "settings.onboardingGateTooltipAmr":
    "後續流程由 AI 執行，請先登入 xDesign Cloud。",
  ...
  "settings.cloudCalloutTitle": "使用 xDesign Cloud",
  ...
  "settings.agentInstall.pathHint":
    "如果你透過 npm 或 Homebrew 安裝了 CLI，但仍顯示為未安裝，請確認該工具的 bin 目錄已加入 xDesign daemon 繼承的 PATH（在 macOS 上，Terminal 與 GUI 應用的 PATH 可能不同）。請參閱 QUICKSTART.md（「Local agent CLI and PATH」章節）。",
  "settings.agentInstall.stepOpenLinks":
    "在目標代理卡片上開啟「安裝」或「文件」連結。",
  "settings.agentInstall.stepAuth":
    "返回 xDesign 前，請先在對應 CLI 完成驗證（登入或新增 API 憑證）。",
  ...
  "settings.amrWalletRefreshTitle": "重新整理 xDesign Cloud 錢包餘額",
  ...
  "settings.amrAccountStatus": "xDesign Cloud 帳戶狀態",
  "settings.amrConsole": "管理",
  "settings.amrLoginErrorCompact": "xDesign Cloud 登入失敗。",
  ...
  "settings.privacy": "隱私",
  "settings.privacyHint": "與 xDesign 團隊共享哪些資料",
  "settings.privacyConsentKicker": "協助我們改進 xDesign",
  "settings.privacyConsentLead":
    "分享使用資料後，我們能更了解 xDesign 在真實工作流裡的表現，並優先改進真正影響體驗的地方。",
  ...
  "settings.mcpTitle": "將 xDesign 連接至程式設計 agent",
  "settings.mcpHint": "透過 MCP，讓支援的 agent 存取您的專案與設計脈絡。",
  "settings.mcpDaemonError":
    "無法連線到本地守護程序以解析安裝路徑（{error}）。請確認 xDesign 正在執行，然後重新開啟此面板。",
  ...
  "settings.mcpCapabilityDefault":
    "將目前在 xDesign 中開啟的專案與檔案作為脈絡。",
  "settings.mcpRunningNote": "請保持 xDesign 執行。設定完成後，重新啟動程式設計 agent。",
  ...
  "entry.discordAria": "加入 xDesign Discord",
  "entry.discordAriaWithOnline": "加入 xDesign Discord - {online}",
  "entry.discordOnlineLabel": "{count} 在線",
  "entry.mailAria": "寄信給 xDesign",
  ...
  "entry.followLinkedinLabel": "在 LinkedIn 上追蹤 xDesign",
  "entry.followXiaohongshuLabel": "在小紅書上追蹤 xDesign",
  ...
  "entry.cloudCalloutTitle": "xDesign Cloud 版",
  "entry.cloudCalloutBody": "登入即可享受雲端協作",
  "entry.cloudCalloutDismissAria": "關閉 xDesign Cloud 版說明",
  ...
  "messageCenter.subtitle": "xDesign 更新、平台公告和權益提醒",
  ...
  "handoff.amrWebsite": "開啟 xDesign Cloud 官網",
  ...
  "handoff.promptIntro": "請基於這個 xDesign 專案的本機資料夾繼續實作：",
  ...
  "pluginsHome.subtitle":
    "隨附於此執行環境、可立即使用的 xDesign 工作流程。挑選一個以載入起始提示，或瀏覽登錄檔取得更多。",
  ...
  "pluginsHome.emptyCatalog":
    "目錄是空的。內建外掛隨 xDesign 一同提供，應會自動出現在此處 — 若問題持續發生，請嘗試重新啟動 daemon。",
  ...
  "pluginCard.contributeAria": "將 {title} 貢獻至 xDesign",
  "pluginCard.contributeTitle": "透過 pull request 將外掛貢獻至 xDesign",
  ...
  "integrations.lede":
    "連接外部系統，把 MCP 工具帶入智能體迴圈，並在其他 IDE、腳本與自動化流程中使用 xDesign。",
  ...
  "mcpClient.daemonError":
    "無法連線到本機 daemon。請確認 xDesign 正在執行，然後重新開啟此面板。",
  "mcpClient.saveFailed": "儲存失敗。請確認 daemon 正在執行後再試一次。",
  "useEverywhere.modalAria": "隨處使用 xDesign",
  "useEverywhere.modalTitle": "隨處使用 xDesign",
  "useEverywhere.modalSubtitle":
    "將 xDesign 接入任何 IDE、Agent 或指令碼 — CLI、HTTP、MCP 及 Skills。使用「複製 Agent 指南」並貼到 Claude Code、Codex、Cursor、openclaw 或 hermes 中，即可設定一切。",
  ...
  "useEverywhere.section.overview.heading":
    "你的 Agent 在哪裡運作，xDesign 就在哪裡運作",
  "useEverywhere.section.overview.intro":
    "xDesign 不只是一個視窗 — 它是一個本機特權 daemon（`od`），外加一個 Skills + Design-Systems + Atoms 登錄。一旦它在您的機器上執行，任何程式碼 Agent（Claude Code、Codex、Cursor、OpenCode/openclaw、Hermes、您自己的指令碼）都能透過四個可互換的介面來驅動產生作業、檢視專案並產出設計成品。",
  "useEverywhere.section.overview.bullet1":
    "CLI — 以 `od <command>` 用於無頭指令碼、CI 及 shell 自動化。",
  "useEverywhere.section.overview.bullet2":
    "MCP server — 將 xDesign 接成 Model Context Protocol 伺服器，讓任何支援 MCP 的 Agent 都能列出技能、執行情境並讀取成品。",
  ...
  "useEverywhere.section.overview.bullet4":
    "Skills — 隨插即用的 `SKILL.md` 套件（相容於 Claude），任何已在您 PATH 上的 Agent 完全無需 xDesign 即可調用。",
  ...
  "useEverywhere.section.cli.heading": "從任何 shell 操作 xDesign",
  ...
  "useEverywhere.section.mcp.heading":
    "將 xDesign 以 MCP 伺服器形式開放給任何程式設計 Agent",
  "useEverywhere.section.mcp.intro":
    "xDesign 隨附一個 Model Context Protocol 伺服器（`od mcp`），讓任何支援 MCP 的用戶端 — Cursor、Claude Code、Antigravity、VS Code Copilot Chat、openclaw、hermes — 都能探索 xDesign 工具（列出技能、算繪預覽、產生媒體、執行外掛），而無需手動使用 shell。daemon 透過 `GET /api/mcp/install-info` 為每個主要用戶端發布可直接貼上的安裝程式碼片段。",
  ...
  "useEverywhere.section.mcp.footer":
    "在 xDesign 應用程式中，開啟「設定 → 整合」即可複製特定用戶端的安裝指令（Cursor、Claude Code、Antigravity、VS Code），而無需手動編輯 JSON。",
  ...
  "useEverywhere.section.skills.heading":
    "適用於任何 Agent 的隨插即用 Skills — 即使 xDesign 未在執行也行",
  "useEverywhere.section.skills.intro":
    "Skill 是一個包含相容於 Claude 的 `SKILL.md`（YAML 前置資料 + 內文）的目錄。xDesign 以 `od:` 命名空間（`mode`、`preview`、`design_system`、`inputs`、…）擴充此格式，因此同一個成品既能在 xDesign 內使用，也能被像 Claude Code、Codex、openclaw 或 hermes 這類原生 Agent 使用。探索作業遵循一條優先順序鏈，因此專案可覆寫自己的技能。",
  ...
  "useEverywhere.section.skills.snippet1":
    "最精簡的 SKILL.md（Claude 相容的前置資料 + xDesign 額外設定）",
  ...
  "entry.githubStarAria": "在 GitHub 為 xDesign 點亮 Star",
  ...
  "newproj.locationDefault": "xDesign 專案",
  ...
  "avatar.amrConsole": "xDesign Cloud 帳戶",
  ...
  "socialShare.openDesignSection": "分享 xDesign",
  "socialShare.openDesignTitle": "GitHub 上的 xDesign",
  "socialShare.openDesignText":
    "xDesign 是原始碼可用的設計智慧工作區，可以生成、編輯、部署並交付設計產物。",
  ...
  "socialShare.projectText":
    "我用 xDesign 做了 {title}。查看已部署產物，也推薦收藏倉庫：{repo}",
  ...
  "chat.brandBrowserAssistDesktopOnly":
    "瀏覽器輔助需要桌面應用，xDesign 才能讀取即時瀏覽器頁面。",
  "chat.brandBrowserAssistReadFailed":
    "無法讀取瀏覽器頁面。請確認品牌網站已開啟並完整載入。",
  "chat.brandBrowserAssistMessage":
    "xDesign 需要瀏覽器輔助才能完成這次品牌擷取。請先在 Browser 分頁清除頁面攔截，然後在下方確認。",
  "brandEnrichment.title": "AI 優化",
  "brandEnrichment.body":
    "xDesign 會在背景執行更深度的抽取，自動套用合適的設計系統 skills，並就地更新這個系統。通常需要 10-20 分鐘，你可以繼續做其他事。",
  ...
  "chat.activeFilePlaceholder": "讓 xDesign 修改 {file}...",
  ...
  "chat.mode.design.solves":
    "當你希望 xDesign 產生檔案、更新 workspace，或把需求變成多模態可交付結果時使用。",
  ...
  "designBrowser.reference.kicker": "xDesign 浏览器",
  ...
  "preview.shareTextDefault": "xDesign 模板：{title}",
  ...
  "preview.errorBody":
    "範例 HTML 載入失敗。請確認 xDesign 正在執行後重試。",
  "preview.retry": "重試",
  ...
  "designFiles.documentTemplate.capabilityAgent":
    "xDesign agent 可以讀取、編輯這份檔案，並把它作為專案上下文。",
  ...
  "designFiles.documentTemplate.nextBody":
    "檢查並編輯這份文件，然後讓 xDesign 基於它生成、修改或執行操作。",
  ...
  "designFiles.usefulInfoTip18":
    "在 YouTube 上訂閱 xDesign，觀看教學和示範。",
  "designFiles.usefulInfoTip19":
    "在 LinkedIn 上追蹤 xDesign，了解產品動態。",
  "designFiles.usefulInfoTip20":
    "在小紅書上追蹤 xDesign，獲取技巧和靈感。",
  ...
  "fileViewer.publishFileRequiresWorkspace": "發布公開連結需要登入工作區。請登入 xDesign Cloud，或使用「部署」發布此檔案。",
  ...
  "assistant.shareToOpenDesign": "分享到 xDesign",
  ...
  "pet.navHint": "領養與自訂",
  "pet.tabBuiltIn": "內建",
  "pet.tabBuiltInHint": "xDesign 內建的精選寵物 — 一鍵領養。",
  "pet.builtInEmpty":
  ...
  "pet.codexBundled": "內建",
  "pet.codexBundledTitle": "xDesign 內建寵物，無需下載。",
  ...
  "settings.projectLocationsDescription":
    "新增可包含多個 xDesign 專案資料夾的工作基目錄。新專案會儲存為所選基目錄中的一個資料夾。",
  ...
  "settings.customInstructionsHint":
    "xDesign 在每次聊天中都應遵循的固定指示。將事實、偏好與專案脈絡儲存為記憶。",
  ...
  "artifact.odCardBrandAssistBody":
    "在瀏覽器中開啟品牌網站，讓 xDesign 繼續擷取此設計體系。",
  ...
  "updater.activeRunsTitle": "xDesign 仍在執行任務",
  "updater.activeRunsBody": "仍有 {count} 個任務正在執行。現在重新啟動會中斷這些任務。",
  "updater.activeRunsUnknownBody": "xDesign 無法確認是否仍有任務執行。現在重新啟動可能會中斷進行中的工作。",
  "updater.availableBody":
    "xDesign {version} 可用。下載完成後即可開啟安裝器。",
  ...
  "updater.payloadReadyGeneric":
    "A new xDesign update is ready. xDesign will close and restart automatically.",
  "updater.payloadReadyVersion":
    "xDesign {version} is ready. xDesign will close and restart automatically.",
  "updater.quitButton": "結束 xDesign",
  "updater.quitFailedBody":
    "安裝器已開啟，但 xDesign 無法結束。替換應用程式前請先結束 xDesign。",
  "updater.quitFailedTitle": "無法結束",
  "updater.quitting": "正在結束…",
  "updater.ready": "更新已就緒",
  "updater.readyGeneric": "新版本已就緒。xDesign 會關閉並開啟安裝器。",
  "updater.readyVersion":
    "xDesign {version} 已就緒。xDesign 會關閉並開啟安裝器。",
  "updater.upToDate": "您已經是最新版本啦",
  "updater.viewVersionFeatures": "查看新版本特色",
  "updater.manualDownload": "手動下載",
  "updater.reinstallLearnMore": "了解詳情",
  "updater.reinstallReadyGeneric": "此更新需要完整重新安裝。xDesign 將關閉並開啟安裝程式。",
  "updater.reinstallReadyVersion": "xDesign {version} 需要完整重新安裝。xDesign 將關閉並開啟安裝程式。",
  "updater.restartAnyway": "仍然重新啟動",

  "whatsNew.updatedTitle": "xDesign {version} 已更新",
  "whatsNew.cta": "查看更新說明",
  ...
  'settings.updateQuitFailed': '安裝程式已開啟，但 xDesign 未能自動結束。',
  ...
  "dsManager.createBody":
    "把你的品牌、產品、程式碼、素材與設計參考教給 xDesign。",
  ...
  "settings.customInstructionsDesc":
    "xDesign 在每次對話中都會遵循的固定指令。它們不是儲存的記憶；事實、偏好與專案脈絡請使用「記憶」。",
  ...
  "brand.librarySubtitle":
    "把你的品牌套件教給 xDesign——從網站擷取一個品牌套件，然後在任意對話中套用它。",
  ...
  "onboarding.buildBody":
    "xDesign 將你的品牌沉澱為可重用的設計系統,讓你之後打造的一切都保持品牌一致。",
  ...
  "dsCreate.sourceSectionBody":
    "從 GitHub repo、網站、DESIGN.md 或能體現風格的檔案開始。xDesign 會先快速建立一套可用系統，之後 AI 可在專案中繼續細化。",
  ...
  "ds.extractionRunningBody": "xDesign 正在就地更新此體系。",
  ...
  "ds.repoConnectBannerBody":
    "連接 GitHub 後，xDesign 可以讀取你的儲存庫，並把顏色、字體和元件擷取到此設計體系中。",
  ...
  'library.getClipper': '取得 xDesign 網頁剪藏擴充功能',
  ...
  'library.emptyHintBefore': '用 xDesign 網頁剪藏擴充功能從任意網頁收藏，執行',
  ...
  'mcp.checking': '檢查中…',
  'mcp.clickConnectHint': '點擊「連線」，透過服務商的 OAuth 流程授予 xDesign 存取權限。',
  ...
  'mcp.noManagedOAuthSaveDirect': '儲存此伺服器後，xDesign 會直接使用它。',
  'mcp.noManagedOAuthUseAsConfigured': 'xDesign 會依你的設定使用此伺服器。如果伺服器需要 token，請在下方新增標頭。',
  ...
  'mcp.starting': '啟動中…',
  'mcp.toGrantOAuthAccess': '透過服務商的 OAuth 流程授予 xDesign 存取權限。',
  ...
  'dsCreate.confirmTitle': 'xDesign 將擷取你的設計系統。',
  ...
  'dsCreate.githubMethodOdAccount': 'xDesign 帳號',
  'dsCreate.githubMethodOdAccountDesc': '由 xDesign 管理的原生 GitHub 登入；此版本尚未使用 OD 託管的 GitHub 權杖。',
  ...
  'dsFlow.activityRunningTitle': 'xDesign 正在更新此設計系統',
  ...
  'dsFlow.jobRebuildingTokens': 'xDesign 正在重建 token',
  'dsFlow.jobRevising': 'xDesign 正在修訂',
  'dsFlow.jobStillWorking': 'xDesign 仍在處理中',
  ...
  'dsFlow.pickLocalAgentFirst': '請先選擇一個本機代理，然後讓 xDesign 更新這個設計系統。',
  'dsFlow.previewPages': '預覽頁面',
  'dsFlow.proposedChanges': '建議的變更',
  'dsFlow.publishCardReady': 'xDesign 已可供審閱。請對目前的成果給出回饋，確認它對後續專案有用後再發布。',
  'dsFlow.publishCardRevision': 'xDesign 正在套用你的回饋。在準備更新草稿期間，你可以繼續審閱。',
  'dsFlow.publishCardTokenRebuild': 'xDesign 正在準備一份供審閱的 token 契約重建。在你接受之前，目前生效的契約保持不變。',
  'dsFlow.publishCardWorking': 'xDesign 仍在處理中，但你已經可以對目前的成果給出回饋。',
  ...
  'pluginDetail.officialBadge': 'xDesign 官方',
  ...
  'campaign.deepseekV4Flash.boundary': '方案內的無限制模型額度與免費生成次數，僅可透過 xDesign 使用；無法在 MCP/CLI/API 及其他場景使用。解釋權歸官方所有。',
