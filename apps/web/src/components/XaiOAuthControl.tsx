    ...
    <div className={`mcp-oauth-control${connected ? ' connected' : ''}`}>
        ...
        {connected ? (
          ...
          <>
            ...
            <span>
              ...
              <span className="hint">
                xDesign is listening for the callback in the background.
          ...
          <>
            ...
            <span>
              ...
              <span className="hint">
                ...
                Grok image, video, and TTS in xDesign — no API key
                needed.
              </span>
            </span>
          </>
      ...
      {isAwaiting ? (
        <div className="xai-oauth-warning" role="status">
          ...
          authorization is still being delivered to xDesign in the
