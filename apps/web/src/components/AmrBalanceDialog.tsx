...
interface Props {
  ...
  /** xDesign Cloud profile from the blocking snapshot; picks the console origin. */
  profile: string | null;
...
// HARD pre-run blocker for xDesign Cloud tasks: the run cannot possibly
...
//
//   signed_out — xDesign Cloud selected but no account session. The CTA
...
export function AmrBalanceDialog({
  ...
  const openUpgrade = () => {
    ...
    // Same attribution handshake as the other xDesign Cloud handoffs
