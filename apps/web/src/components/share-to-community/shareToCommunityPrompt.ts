// Trigger prompt for the post-completion "Share to xDesign" submission
...
export const SHARE_TO_COMMUNITY_PROMPT = [
  'Package the work I just finished in this project as an xDesign plugin so I can install it into My plugins and open a PR to the xDesign community catalog.',
  '',
