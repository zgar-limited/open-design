...
export function buildDesignManifestContent(opts: {
  ...
  const title = opts.title || 'xDesign artifact';
...
- Keep generated product UI free of xDesign chrome, preview labels, or design-process annotations.
...
- Do not keep prototype-only annotations, frame labels, or xDesign chrome in the production UI.
