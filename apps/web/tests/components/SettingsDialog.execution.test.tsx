...
describe('SettingsDialog execution settings Local CLI interactions', () => {
  ...
  it('pins xDesign to the top of the installed CLI list', () => {
...
describe('SettingsDialog MCP server interactions', () => {
  const installInfo = {
    command: '/Applications/xDesign.app/Contents/Resources/open-design/bin/node',
    args: [
      '/Applications/xDesign.app/Contents/Resources/app/node_modules/@open-design/daemon/dist/cli.js',
      'mcp',
      '--daemon-url',
  ...
  it('renders the default Claude Code install snippet after fetching daemon install info', async () => {
    ...
    expect(screen.getByRole('heading', { name: /Connect xDesign to your coding agent/i })).toBeTruthy();
    ...
    expect(screen.getByText(/Keep xDesign running\. Restart your coding agent after setup\./i)).toBeTruthy();
...
describe('SettingsDialog about interactions', () => {
  ...
  it('downloads an available packaged update from the about page', async () => {
    ...
    const downloaded = updateStatus({
      artifact: {
        name: 'xDesign Beta.dmg',
        platformKey: 'macAppleSilicon',
        type: 'dmg',
        url: 'https://fixture.test/xDesign Beta.dmg',
      },
      availableVersion: '1.2.3-beta.4',
